<template>
    <div class="flex flex-row space-x-2">
        <input
            ...
            :placeholder="$t('app.questionPlaceholder')" v-model="query" @input="$emit('update:query', $event.target.value)"
        ...
        <div
            ...
            <button v-if="!pending && !error" @click="askQuestion()" class="w-9 h-9">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-9 h-9 text-gray-600">
            ...
            <div v-if="pending && !error">
                <div role="status">
                    <svg aria-hidden="true" class="w-9 h-9 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
            ...
            <button v-if="!pending && error" @click="askQuestion()" class="w-9 h-9" :title="error.message">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-9 h-9 text-red-600">
                    <path stroke-linecap="round" stroke-linejoin="round"
