<template>
    <div class="rounded-md bg-slate-100 p-6 border border-gray-300 hover:bg-slate-200/60 transition duration-300"
        v-if="answer.context">
        ...
        <Alert :text="$t('l10n.quoteStart') + answer.answer + $t('l10n.quoteEnd')" color="green" v-if="answer.answer"
            class="my-4" />
        ...
        <div class="flex flex-col space-y-2" v-if="answer.metadata">
            <h2 class="text-gray-500">{{ $t('app.source') }}</h2>
        ...
        <div class="flex flex-row space-x-2 justify-end">
            ...
            <div class="cursor-pointer text-blue-600 hover:text-blue-800 transition duration-300"
                :title="$t('app.feedback.like')" @click="sendFeedback">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            ...
            <div class="cursor-pointer text-orange-600 hover:text-orange-800 transition duration-300"
                :title="$t('app.feedback.dislike')" @click="feedback = !feedback">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
